...
discountCodeHelper.createRechargeCode = function(codeModel,callback){
    var loginInsert = "INSERT INTO discountCode SET email='" + codeModel.email + "' ,discountCode='" + codeModel.discountCode + "', buyCount='" + codeModel.buyCount + "', status='" + 0 + "', createTime='" + codeModel.createTime + "', totalBuyCount='" + codeModel.totalBuyCount + "',payMonney = '"+codeModel.payMonney+"';";
