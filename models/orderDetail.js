...
orderDetailUtils.cardDetailByOrderIdUpdateState = async function(order_id,callback){
    var descGetCardId = "update orders set status = 'yes' where order_id = '"+order_id+"';";
	query(descGetCardId)
        .then((results) => {
            return results;
        })
